...
- v 16
	- Behold, 
		- I am sending you out #I-Am/Sent-Out 
			- like sheep among wolves; #I-Am/Sent-Out/Like-Sheep/Among-Wolves  
	- therefore
		- be as shrewd as snakes #Command/Be/As-Shrewd-As-Snakes
		- and as innocent as doves. #Command/Be/As-Innocent/As-Doves
- *am sending you out - G649 - apostelló* #Greek/G649-apostelló
	- to sent, send away (as a messenger, commission, etc)
	- **HELPS Word-studies**
		- **649** *apostéllō* (from [575](https://biblehub.com/greek/575.htm) */apó*, "away from" and [4724](https://biblehub.com/greek/4724.htm) */stéllō*, "send") – properly, send away, i.e. *commission*; (passive) "*sent* on a *defined mission* by a superior."
		- As an *intensification* of [4724](https://biblehub.com/greek/4724.htm) */stéllō* ("send"), [649](https://biblehub.com/greek/649.htm) (*apostéllō*) **focuses back to *the source* (the one sending), strongly connecting *the sender to the one sent* (His mission)**. This verb **is used of closely connecting *the Lord* (the sender) to the believers He personally commissions** – as with John the Baptist (Mk 11:2) and the twelve apostles (Mt 10:5; cf. also with His holy angels, Mk 13:27).
- *as shrewd - G5429 - phronimos* #Greek/G5429-phronimos 
	- practically wise, sensible; intelligent, prudent
	- **HELPS Word-studies**
		- **Cognate: 5429** *phrónimos* (an adjective, derived from [5424](https://biblehub.com/greek/5424.htm) */phrḗn*, "personal perspective regulating outward behavior," and the root of the English term "diaphragm" which controls key body functions *from the inside out*) – **properly, "how we size things up," reflecting our personal ("visceral") opinions**, i.e. what we consider "savvy" (smart). This **always roots to our *personal perspective* ("inner outlook") which *regulates* our definition of being "shrewd,**" i.e. **reflects personal *mind*-set** (_in_sight). [See 5426](https://biblehub.com/greek/5426.htm) (*phroneō*).
